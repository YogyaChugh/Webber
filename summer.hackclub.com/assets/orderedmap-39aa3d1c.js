...
OrderedMap.prototype = {
    ...
    remove: function(t) {
        ...
        n.splice(e, 2);
        return new OrderedMap(n)
    },
    addToStart: function(t, e) {
        return new OrderedMap([t, e].concat(this.remove(t).content))
    },
    ...
    addBefore: function(t, e, n) {
        var r = this.remove(e),
            o = r.content.slice();
        var i = r.find(t);
        o.splice(-1 == i ? o.length : i, 0, e, n);
        return new OrderedMap(o)
    },
    forEach: function(t) {
    ...
    prepend: function(t) {
        t = OrderedMap.from(t);
        return t.size ? new OrderedMap(t.content.concat(this.subtract(t).content)) : this
    },
    append: function(t) {
        t = OrderedMap.from(t);
        return t.size ? new OrderedMap(this.subtract(t).content.concat(t.content)) : this
    },
    subtract: function(t) {
        var e = this;
        t = OrderedMap.from(t);
...
OrderedMap.from = function(t) {
    if (t instanceof OrderedMap) return t;
    var e = [];
    if (t)
