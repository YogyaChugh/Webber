...
function C(e) {
    return A(e, "a[href]:not([target^=_]):not([download])")
}
...
function N(e, t) {
    return O(e, t) && !F.drive.unvisitableExtensions.has(B(e))
}
...
function $(e, t = {}) {
    const s = new Headers(t.headers || {}),
        r = m();
    return U.add(r), s.append("X-Turbo-Request-Id", r), _(e, {
        ...t,
        headers: s
    })
}
...
class X {
    ...
    async perform() {
        ...
        try {
            this.delegate.requestStarted(this), t.detail.fetchRequest ? this.response = t.detail.fetchRequest.response : this.response = $(this.url.href, e);
    ...
    async receive(e) {
        const t = new V(e);
        return o("turbo:before-fetch-response", {
            cancelable: !0,
            detail: {
                fetchResponse: t
            },
    ...
    #r(e) {
        return !o("turbo:fetch-request-error", {
            target: this.target,
            cancelable: !0,
            detail: {
                request: this,
...
class ie {
    ...
    constructor(e, t, s, r = !1) {
        ...
        this.delegate = e, this.formElement = t, this.submitter = s, this.fetchRequest = new X(this, i, n, o, t, a), this.mustRedirect = r
    }
    get method() {
    ...
    async start() {
        const {
            initialized: e,
            requesting: t
        } = re, s = p("data-turbo-confirm", this.submitter, this.formElement);
        if ("string" == typeof s) {
    ...
    requestStarted(e) {
        this.state = re.waiting, this.submitter && F.forms.submitter.beforeSubmit(this.submitter), this.setSubmitsWith(), f(this.formElement), o("turbo:submit-start", {
    ...
    requestSucceededWithResponse(e, t) {
        ...
        else if (se.clear(), this.requestMustRedirect(e) && function(e) {
        ...
        } else this.state = re.receiving, this.result = {
            success: !0,
            fetchResponse: t
    ...
    requestFinished(e) {
        this.state = re.stopped, this.submitter && F.forms.submitter.afterSubmit(this.submitter), this.resetSubmitterText(), g(this.formElement), o("turbo:submit-end", {
            target: this.formElement,
            detail: {
                formSubmission: this,
                ...this.result
...
class le {
    ...
    async render(e) {
        ...
        if (s) try {
            this.renderPromise = new Promise((e => this.#o = e)), this.renderer = e, await this.prepareToRenderSnapshot(e);
...
class fe {
    ...
    constructor(e, t, s, r = !0) {
        this.currentSnapshot = e, this.newSnapshot = t, this.isPreview = s, this.willRender = r, this.renderElement = this.constructor.renderElement, this.promise = new Promise(((e, t) => this.resolvingFunctions = {
            resolve: e,
            reject: t
        }))
    }
...
class ge extends fe {
    ...
    async render() {
        await c(), this.preservingPermanentElements((() => {
            this.loadFrameElement()
        })), this.scrollFrameIntoView(), await c(), this.focusFirstAutofocusableElement(), await c(), this.activateScriptElements()
    }
    loadFrameElement() {
...
var be = function() {
    ...
    const s = function() {
            ...
            const t = function() {
                ...
                return function(s, r, i, n) {
                    ...
                    for (; l && l != n;) {
                        ...
                        if (null === o && a && t(l, a) && (c++, a = a.nextSibling, c >= 2 && (o = void 0)), l.contains(document.activeElement)) break;
                        l = l.nextSibling
                    }
                    return o || null
                }
            ...
            return function(o, a, c, l = null, h = null) {
                a instanceof HTMLTemplateElement && c instanceof HTMLTemplateElement && (a = a.content, c = c.content), l ||= a.firstChild;
        ...
        r = function() {
            ...
            return function(n, o, a) {
                return a.ignoreActive && n === document.activeElement ? null : (!1 === a.callbacks.beforeNodeMorphed(n, o) || (n instanceof HTMLHeadElement && a.head.ignore || (n instanceof HTMLHeadElement && "morph" !== a.head.style ? i(n, o, a) : (! function(s, i, n) {
                    let o = i.nodeType;
                    if (1 === o) {
                        const o = s,
                            a = i,
                            c = o.attributes,
                            l = a.attributes;
                        for (const e of l) t(e.name, o, "update", n) || o.getAttribute(e.name) !== e.value && o.setAttribute(e.name, e.value);
                        ...
                        r(o, n) || function(s, r, i) {
                            if (s instanceof HTMLInputElement && r instanceof HTMLInputElement && "file" !== r.type) {
                                let n = r.value,
                                    o = s.value;
                                e(s, r, "checked", i), e(s, r, "disabled", i), r.hasAttribute("value") ? o !== n && (t("value", s, "update", i) || (s.setAttribute("value", n), s.value = n)) : t("value", s, "remove", i) || (s.value = "", s.removeAttribute("value"))
                            } else if (s instanceof HTMLOptionElement && r instanceof HTMLOptionElement) e(s, r, "selected", i);
                            else if (s instanceof HTMLTextAreaElement && r instanceof HTMLTextAreaElement) {
                                let e = r.value,
                                    n = s.value;
                                if (t("value", s, "update", i)) return;
                                e !== n && (s.value = e), s.firstChild && s.firstChild.nodeValue !== e && (s.firstChild.nodeValue = e)
                            }
                        }(o, a, n)
                    }
                    8 !== o && 3 !== o || s.nodeValue !== i.nodeValue && (s.nodeValue = i.nodeValue)
                }(n, o, a), r(n, a) || s(a, n, o))), a.callbacks.afterNodeMorphed(n, o)), n)
            }
        }();
    ...
    function i(e, t, s) {
        ...
        for (const t of e.children) {
            ...
            e || c ? r ? i.push(t) : (a.delete(t.outerHTML), n.push(t)) : "append" === s.head.style ? r && (i.push(t), o.push(t)) : !1 !== s.head.shouldRemove(t) && i.push(t)
        }
        o.push(...a.values());
        let c = [];
        for (const t of o) {
    ...
    const n = function() {
            ...
            return function(i, n, o) {
                const {
                    ...
                    const i = s(e),
                        ...
                        o = function(e, t) {
                            ...
                            for (const {
                                ...
                                of e) r.has(t) ? s.add(t) : r.set(t, i);
                            let i = new Set;
                            for (const {
                                    id: e,
                                    tagName: n
                                }
                                of t) i.has(e) ? s.add(e) : r.get(e) === n && i.add(e);
                    ...
                    return Object.assign(s, e), s.callbacks = Object.assign({}, t.callbacks, e.callbacks), s.head = Object.assign({}, t.head, e.head), s
                }(o), h = l.morphStyle || "outerHTML";
        ...
        }(),
        {
            ...
            return {
                ...
                normalizeParent: function t(s) {
                    ...
                    if ("string" == typeof s) return t(function(t) {
                        let s = new DOMParser,
                        ...
                        if (r.match(/<\/html>/) || r.match(/<\/head>/) || r.match(/<\/body>/)) {
                            ...
                            let r = s.parseFromString("<body><template>" + t + "</template></body>", "text/html").body.querySelector("template").content;
                            return e.add(r), r
                        }
                    }(s));
                    if (e.has(s)) return s;
                    if (s instanceof Node) {
                        if (s.parentNode) return function(e) {
                            return {
                                childNodes: [e],
                                querySelectorAll: t => {
        ...
        morph: function(e, t, r = {}) {
            ...
            const c = a(t),
                ...
                h = function(e, t) {
                    ...
                    return r(e)
                }(l, e, c, (t => "innerHTML" === t.morphStyle ? (s(t, e, c), Array.from(e.childNodes)) : function(e, t, r) {
                    const i = a(t);
...
class we {
    ...
    beforeAttributeUpdated = (e, t, s) => !o("turbo:before-morph-attribute", {
        cancelable: !0,
        target: t,
        detail: {
            attributeName: e,
    ...
    afterNodeMorphed = (e, t) => {
        e instanceof Element && o("turbo:morph-element", {
            target: e,
            detail: {
                currentElement: e,
                newElement: t
...
class Ee {
    ...
    fadeProgressElement(e) {
        this.progressElement.style.opacity = "0", setTimeout(e, 1.5 * Ee.animationDuration)
    }
    uninstallProgressElement() {
        this.progressElement.parentNode && document.documentElement.removeChild(this.progressElement)
    }
    startTrickling() {
        this.trickleInterval || (this.trickleInterval = window.setInterval(this.trickle, Ee.animationDuration))
    }
    stopTrickling() {
    ...
    createStylesheetElement() {
        ...
        e.type = "text/css", e.textContent = Ee.defaultCSS;
        const t = E();
...
class Te extends ne {
    ...
    clone() {
        ...
        return new Te(this.documentElement, e, this.headSnapshot)
    }
    get lang() {
...
class Ce {
    ...
    #d = Promise.resolve();
    renderChange(e, t) {
        return e && this.viewTransitionsAvailable && !this.#h ? (this.#h = !0, this.#d = this.#d.then((async () => {
            await document.startViewTransition(t).finished
        }))) : this.#d = this.#d.then(t), this.#d
    }
...
class Ue {
    ...
    constructor(e, t, s, r = {}) {
        ...
        this.action = i, this.historyChanged = n, this.referrer = o, this.snapshot = a, this.snapshotHTML = c, this.response = l, this.isSamePage = this.delegate.locationWithActionIsSamePage(this.location, this.action), this.isPageRefresh = this.view.isPageRefresh(this), this.visitCachedSnapshot = h, this.willRender = d, this.updateHistory = u, this.scrolled = !d, this.shouldCacheSnapshot = p, this.acceptsStreamResponse = f, this.direction = g || We[i]
    }
    get adapter() {
    ...
    start() {
        this.state == qe && (this.recordTimingMetric(ke), this.state = He, this.adapter.visitStarted(this), this.delegate.visitStarted(this))
    }
    cancel() {
        this.state == He && (this.request && this.request.cancel(), this.cancelRender(), this.state = Be)
    }
    complete() {
        this.state == He && (this.recordTimingMetric(Ie), this.adapter.visitCompleted(this), this.state = Ne, this.followRedirect(), this.followedRedirect || this.delegate.visitCompleted(this))
    }
    fail() {
        this.state == He && (this.state = Oe, this.adapter.visitFailed(this), this.delegate.visitCompleted(this))
    }
    changeHistory() {
    ...
    issueRequest() {
        this.hasPreloadedResponse() ? this.simulateRequest() : this.shouldIssueRequest() && !this.request && (this.request = new X(this, z.get, this.location), this.request.perform())
    }
    simulateRequest() {
        this.response && (this.startRequest(), this.recordResponse(), this.finishRequest())
    }
    startRequest() {
        this.recordTimingMetric(Me), this.adapter.visitRequestStarted(this)
    }
    recordResponse(e = this.response) {
        if (this.response = e, e) {
            ...
            _e(t) ? this.adapter.visitRequestCompleted(this) : this.adapter.visitRequestFailedWithStatusCode(this, t)
        }
    }
    finishRequest() {
        this.recordTimingMetric(Fe), this.adapter.visitRequestFinished(this)
    }
    loadResponse() {
        if (this.response) {
            const {
            ...
            this.render((async () => {
                if (this.shouldCacheSnapshot && this.cacheSnapshot(), this.view.renderPromise && await this.view.renderPromise, _e(e) && null != t) {
                    const e = Te.fromHTMLString(t);
                    await this.renderPageSnapshot(e, !1), this.adapter.visitRendered(this), this.complete()
                } else await this.view.renderError(Te.fromHTMLString(t), this), this.adapter.visitRendered(this), this.fail()
            }))
        }
    }
    getCachedSnapshot() {
        const e = this.view.getCachedSnapshotForLocation(this.location) || this.getPreloadedSnapshot();
        if (e && (!q(this.location) || e.hasAnchor(q(this.location))) && ("restore" == this.action || e.isPreviewable)) return e
    }
    getPreloadedSnapshot() {
        if (this.snapshotHTML) return Te.fromHTMLString(this.snapshotHTML)
    }
    hasCachedSnapshot() {
...
class $e {
    ...
    visitProposedToLocation(e, t) {
        N(e, this.navigator.rootLocation) ? this.navigator.startVisit(e, t?.restorationIdentifier || m(), t) : window.location.href = e.toString()
    }
    visitStarted(e) {
...
class ze {
    constructor(e, t) {
        this.session = e, this.element = t, this.linkInterceptor = new de(this, t), this.formSubmitObserver = new ce(this, t)
    }
    start() {
...
class Je {
    ...
    start() {
        this.started || ("loading" === this.eventTarget.readyState ? this.eventTarget.addEventListener("DOMContentLoaded", this.#g, {
            once: !0
        }) : this.#g())
    }
    stop() {
        this.started && (this.eventTarget.removeEventListener("mouseenter", this.#b, {
            capture: !0,
            passive: !0
        }), this.eventTarget.removeEventListener("mouseleave", this.#v, {
            capture: !0,
            passive: !0
        }), this.eventTarget.removeEventListener("turbo:before-fetch-request", this.#S, !0), this.started = !1)
    }
    #g = () => {
        this.eventTarget.addEventListener("mouseenter", this.#b, {
            ...
            capture: !0,
            passive: !0
        }), this.eventTarget.addEventListener("turbo:before-fetch-request", this.#S, !0), this.started = !0
    };
    #b = e => {
        ...
        if (t.matches && t.matches("a[href]:not([target^=_]):not([download])") && this.#w(t)) {
            ...
            if (this.delegate.canPrefetchRequestToLocation(e, s)) {
                ...
                se.setLater(s.toString(), r, this.#y)
            }
        }
    };
    #v = e => {
    ...
    #w(e) {
        return !!e.getAttribute("href") && (!Xe(e) && (!Ke(e) && (!Qe(e) && (!Ye(e) && !et(e)))))
    }
}
const Xe = e => e.origin !== document.location.origin || !["http:", "https:"].includes(e.protocol) || e.hasAttribute("target"),
    Ke = e => e.pathname + e.search === document.location.pathname + document.location.search || e.href.startsWith("#"),
    Qe = e => {
    ...
    Ye = e => {
        ...
        return !(!t || "get" === t.toLowerCase()) || (!!Ze(e) || (!!e.hasAttribute("data-turbo-confirm") || !!e.hasAttribute("data-turbo-stream")))
    },
    Ze = e => e.hasAttribute("data-remote") || e.hasAttribute("data-behavior") || e.hasAttribute("data-confirm") || e.hasAttribute("data-method"),
    et = e => o("turbo:before-prefetch", {
        target: e,
        cancelable: !0
    }).defaultPrevented;
class tt {
    ...
    startVisit(e, t, s = {}) {
        this.stop(), this.currentVisit = new Ue(this, I(e), t, {
    ...
    linkPrefetchingIsEnabledForLocation(e) {
        return "function" != typeof this.adapter.linkPrefetchingIsEnabledForLocation || this.adapter.linkPrefetchingIsEnabledForLocation(e)
    }
    visitStarted(e) {
    ...
    locationWithActionIsSamePage(e, t) {
        ...
        return "replace" !== t && D(e) === D(this.view.lastRenderedLocation) && (i || null != s && s !== r)
    }
...
class ot {
    ...
    start() {
        this.started || (this.stage == st && (this.stage = rt), document.addEventListener("readystatechange", this.interpretReadyState, !1), addEventListener("pagehide", this.pageWillUnload, !1), this.started = !0)
    }
    stop() {
    ...
    pageIsInteractive() {
        this.stage == rt && (this.stage = it, this.delegate.pageBecameInteractive())
    }
    pageIsComplete() {
        this.pageIsInteractive(), this.stage == it && (this.stage = nt, this.delegate.pageLoaded())
    }
    pageWillUnload = () => {
...
class ct {
    render({
        ...
        pe.preservingPermanentElements(this, function(e) {
            ...
            !async function(e, t) {
                const s = `turbo-stream-autofocus-${m()}`,
                    ...
                    i = function(e) {
                        for (const t of e) {
                            const e = L(t.templateElement.content);
                            if (e) return e
                        }
                        return null
                    }(r);
...
class lt {
    ...
    start() {
        this.#L || (this.#L = !0, addEventListener("turbo:before-fetch-response", this.inspectFetchResponse, !1))
    }
    stop() {
        this.#L && (this.#L = !1, removeEventListener("turbo:before-fetch-response", this.inspectFetchResponse, !1))
    }
    ...
    receiveMessageEvent = e => {
        this.#L && "string" == typeof e.data && this.receiveMessageHTML(e.data)
    };
...
class ut extends dt {
    static renderElement(e, t) {
        ve(e, t, {
            callbacks: {
                beforeNodeMorphed: e => !mt(e)
            }
        });
        for (const t of e.querySelectorAll("turbo-frame")) mt(t) && t.reload();
        o("turbo:morph", {
            detail: {
                currentElement: e,
                newElement: t
...
function mt(e) {
    return e instanceof r && e.src && "morph" === e.refresh && !e.closest("[data-turbo-permanent]")
}
class pt {
    keys = [];
    snapshots = {};
    ...
    read(e) {
        return this.snapshots[x(e)]
    }
    write(e, t) {
        this.snapshots[x(e)] = t
    }
    touch(e) {
        const t = x(e),
...
class ft extends le {
    ...
    renderPage(e, t = !1, s = !0, r) {
        const i = new(this.isPageRefresh(r) && this.snapshot.shouldMorphPage ? ut : dt)(this.snapshot, e, t, s);
        return i.shouldRender ? r?.changeHistory() : this.forceReloaded = !0, this.render(i)
    }
    renderError(e, t) {
        t?.changeHistory();
        const s = new ht(this.snapshot, e, !1);
    ...
    get snapshot() {
        return Te.fromElement(this.element)
    }
}
class gt {
    ...
    start() {
        "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", this.#C) : this.preloadOnLoadLinksForView(document.body)
    }
    stop() {
...
const St = {
    ...
    wt = new class {
        navigator = new tt(this);
        history = new Ge(this);
        view = new ft(this, document.documentElement);
        adapter = new $e(this);
        pageObserver = new ot(this);
        cacheObserver = new je;
        linkPrefetchObserver = new Je(this, document);
        linkClickObserver = new ue(this, window);
        formSubmitObserver = new ce(this, document);
        scrollObserver = new at(this);
        streamObserver = new lt(this);
        formLinkClickObserver = new me(this, document.documentElement);
        frameRedirector = new ze(this, document.documentElement);
        streamMessageRenderer = new ct;
        cache = new bt(this);
        enabled = !0;
        started = !1;
        #k = 150;
        constructor(e) {
            this.recentRequests = e, this.preloader = new gt(this, this.view.snapshotCache), this.debouncedRefresh = this.refresh, this.pageRefreshDebouncePeriod = this.pageRefreshDebouncePeriod
        }
        start() {
        ...
        refresh(e, t) {
            ...
            s || this.navigator.currentVisit || !r || this.visit(e, {
                action: "replace",
                shouldCacheSnapshot: !1
            })
        }
        ...
        set pageRefreshDebouncePeriod(e) {
            ...
            }(this.debouncedRefresh.bind(this), e), this.#k = e
        }
        shouldPreloadLink(e) {
            ...
            {
                const t = new URL(e.href);
                return this.elementIsNavigatable(e) && N(t, this.snapshot.rootLocation)
            }
        }
        ...
        canPrefetchRequestToLocation(e, t) {
            return this.elementIsNavigatable(e) && N(t, this.snapshot.rootLocation) && this.navigator.linkPrefetchingIsEnabledForLocation(t)
        }
        willFollowLinkToLocation(e, t, s) {
            return this.elementIsNavigatable(e) && N(t, this.snapshot.rootLocation) && this.applicationAllowsFollowingLinkToLocation(e, t, s)
        }
        followedLinkToLocation(e, t) {
        ...
        visitProposedToLocation(e, t) {
            vt(e), this.adapter.visitProposedToLocation(e, t)
        }
        visitStarted(e) {
            e.acceptsStreamResponse || (f(document.documentElement), this.view.markVisitDirection(e.direction)), vt(e.location), e.silent || this.notifyApplicationAfterVisitingLocation(e.location, e.action)
        }
        visitCompleted(e) {
            this.view.unmarkVisitDirection(), g(document.documentElement), this.notifyApplicationAfterPageLoad(e.getTimingMetrics())
        }
        locationWithActionIsSamePage(e, t) {
        ...
        willSubmitForm(e, t) {
            const s = H(e, t);
            return this.submissionIsNavigatable(e, t) && N(I(s), this.snapshot.rootLocation)
        }
        formSubmitted(e, t) {
        ...
        notifyApplicationAfterFrameLoad(e) {
            return o("turbo:frame-load", {
                target: e
            })
        }
        notifyApplicationAfterFrameRender(e, t) {
            return o("turbo:frame-render", {
                detail: {
                    fetchResponse: e
                },
                target: t,
        ...
        submissionIsNavigatable(e, t) {
            if ("off" == F.forms.mode) return !1;
            {
                ...
                return "optin" == F.forms.mode ? s && null != e.closest('[data-turbo="true"]') : s && this.elementIsNavigatable(e)
            }
        }
        elementIsNavigatable(e) {
            const t = A(e, "[data-turbo]"),
                s = A(e, "turbo-frame");
            return F.drive.enabled || s ? !t || "false" != t.getAttribute("data-turbo") : !!t && "true" == t.getAttribute("data-turbo")
        }
        getActionForLink(e) {
            return S(e) || "advance"
        }
...
function Tt(e) {
    wt.connectStreamSource(e)
}

function Ct(e) {
    wt.disconnectStreamSource(e)
}

function Pt(e) {
    wt.renderStreamMessage(e)
}

function kt() {
    console.warn("Please replace `Turbo.clearCache()` with `Turbo.cache.clear()`. The top-level function is deprecated and will be removed in a future version of Turbo.`"), wt.clearCache()
}
...
var qt = Object.freeze({
    ...
    registerAdapter: Rt,
    visit: Lt,
    connectStreamSource: Tt,
    disconnectStreamSource: Ct,
    renderStreamMessage: Pt,
    clearCache: kt,
    setProgressBarDelay: Mt,
    setConfirmMethod: Ft,
    setFormMode: It
});
...
function Ot(e, t) {
    if (e) {
        ...
        if (null != i && null != t && (s = t, I(i).href == I(s).href)) throw new Error(`Matching <turbo-frame id="${e.id}"> element has a source URL which references itself`);
...
const Nt = {
    ...
    refresh() {
        wt.refresh(this.baseURI, this.requestId)
    }
};
class Dt extends HTMLElement {
    ...
    get duplicateChildren() {
        const e = this.targetElements.flatMap((e => [...e.children])).filter((e => !!e.getAttribute("id"))),
            t = [...this.templateContent?.children || []].filter((e => !!e.getAttribute("id"))).map((e => e.getAttribute("id")));
        return e.filter((e => t.includes(e.getAttribute("id"))))
    }
    get performAction() {
        if (this.action) {
            const e = Nt[this.action];
            if (e) return e;
    ...
    get targetElements() {
        return this.target ? this.targetElementsById : this.targets ? this.targetElementsByQuery : void this.#M("target or targets attribute is missing")
    }
    get templateContent() {
...
class xt extends HTMLElement {
    streamSource = null;
    connectedCallback() {
        this.streamSource = this.src.match(/^ws{1,2}:/) ? new WebSocket(this.src) : new EventSource(this.src), Tt(this.streamSource)
    }
    disconnectedCallback() {
        this.streamSource && (this.streamSource.close(), Ct(this.streamSource))
    }
    get src() {
        return this.getAttribute("src") || ""
    }
...
r.delegateConstructor = class {
    ...
    action = null;
    constructor(e) {
        this.element = e, this.view = new he(this, this.element), this.appearanceObserver = new ee(this, this.element), this.formLinkClickObserver = new me(this, this.element), this.linkInterceptor = new de(this, this.element), this.restorationIdentifier = m(), this.formSubmitObserver = new ce(this, this.element)
    }
    connect() {
        this.#q || (this.#q = !0, this.loadingStyle == s.lazy ? this.appearanceObserver.start() : this.#N(), this.formLinkClickObserver.start(), this.linkInterceptor.start(), this.formSubmitObserver.start())
    }
    disconnect() {
        this.#q && (this.#q = !1, this.appearanceObserver.stop(), this.formLinkClickObserver.stop(), this.linkInterceptor.stop(), this.formSubmitObserver.stop())
    }
    disabledChanged() {
        this.loadingStyle == s.eager && this.#N()
    }
    sourceURLChanged() {
        this.#D("src") || (this.element.isConnected && (this.complete = !1), (this.loadingStyle == s.eager || this.#H) && this.#N())
    }
    sourceURLReloaded() {
        const {
            refresh: e,
        ...
        return this.#O = t && "morph" === e, this.element.removeAttribute("complete"), this.element.src = null, this.element.src = t, this.element.loaded
    }
    loadingStyleChanged() {
        this.loadingStyle == s.lazy ? this.appearanceObserver.start() : (this.appearanceObserver.stop(), this.#N())
    }
    async #N() {
        this.enabled && this.isActive && !this.complete && this.sourceURL && (this.element.loaded = this.#x(I(this.sourceURL)), this.appearanceObserver.stop(), await this.element.loaded, this.#H = !0)
    }
    async loadResponse(e) {
        ...
        try {
            ...
            if (t) {
                const s = d(t);
                Te.fromDocument(s).isVisitable ? await this.#V(e, s) : await this.#W(e)
            }
        } finally {
    ...
    prepareRequest(e) {
        e.headers["Turbo-Frame"] = this.id, this.currentNavigationElement?.hasAttribute("data-turbo-stream") && e.acceptResponseType(te.contentType)
    }
    requestStarted(e) {
        f(this.element)
    }
    ...
    formSubmissionSucceededWithResponse(e, t) {
        ...
        s.delegate.proposeVisitIfNavigatedWithAction(s, S(e.submitter, e.formElement, s)), s.delegate.loadResponse(t), e.isSafe || wt.clearCache()
    }
    formSubmissionFailedWithResponse(e, t) {
        this.element.delegate.loadResponse(t), wt.clearCache()
    }
    formSubmissionErrored(e, t) {
        console.error(t)
    }
    ...
    allowsImmediateRender({
        ...
        const s = o("turbo:before-frame-render", {
                target: this.element,
                detail: {
                    newFrame: e,
                    ...t
    ...
    viewRenderedSnapshot(e, t, s) {}
    preloadOnLoadLinksForView(e) {
        wt.preloadOnLoadLinksForView(e)
    }
    viewInvalidated() {}
    willRenderFrame(e, t) {
    ...
    async #V(e, t) {
        ...
        if (s) {
            ...
            this.view.renderPromise && await this.view.renderPromise, this.changeHistory(), await this.view.render(i), this.complete = !0, wt.frameRendered(e, this.element), wt.frameLoaded(this.element), await this.fetchResponseLoaded(e)
        } else this.#$(e) && this.#j(e)
    }
    async #x(e) {
        const t = new X(this, z.get, e, new URLSearchParams, this.element);
        return this.#F?.cancel(), this.#F = t, new Promise((e => {
            this.#I = () => {
    ...
    #_(e, t, s) {
        const r = this.#m(e, s);
        r.delegate.proposeVisitIfNavigatedWithAction(r, S(s, e, r)), this.#z(e, (() => {
            r.src = t
        }))
    }
    proposeVisitIfNavigatedWithAction(e, t = null) {
        if (this.action = t, this.action) {
            const t = Te.fromElement(e).clone(),
                {
            ...
            e.delegate.fetchResponseLoaded = async r => {
                if (e.src) {
                    ...
                    this.action && (o.action = this.action), wt.visit(e.src, o)
                }
            }
        }
    }
    changeHistory() {
        if (this.action) {
            ...
            wt.history.update(e, I(this.element.src || ""), this.restorationIdentifier)
        }
    }
    async #W(e) {
        console.warn(`The response (${e.statusCode}) from <turbo-frame id="${this.element.id}"> is performing a full page visit due to turbo-visit-control.`), await this.#G(e.response)
    }
    #$(e) {
        ...
        return !o("turbo:frame-missing", {
            ...
            detail: {
                response: t,
                visit: async (e, t) => {
                    e instanceof Response ? this.#G(e) : wt.visit(e, t)
                }
            },
            cancelable: !0
        }).defaultPrevented
    ...
    #m(e, t) {
        return Bt(p("data-turbo-frame", t, e) || this.element.getAttribute("target")) ?? this.element
    }
    async extractForeignFrameElement(e) {
        let t;
        const s = CSS.escape(this.id);
        try {
            if (t = Ot(e.querySelector(`turbo-frame#${s}`), this.sourceURL), t) return t;
            if (t = Ot(e.querySelector(`turbo-frame[src][recurse~=${s}]`), this.sourceURL), t) return await t.loaded, await this.extractForeignFrameElement(t)
        } catch (e) {
    ...
    #X(e, t) {
        return N(I(H(e, t)), this.rootLocation)
    }
    #U(e, t) {
        ...
        return !!wt.elementIsNavigatable(e) && !(t && !wt.elementIsNavigatable(t))
    }
    get id() {
...
}, void 0 === customElements.get("turbo-frame") && customElements.define("turbo-frame", r), void 0 === customElements.get("turbo-stream") && customElements.define("turbo-stream", Dt), void 0 === customElements.get("turbo-stream-source") && customElements.define("turbo-stream-source", xt), (() => {
    let e = document.currentScript;
    if (e && !e.hasAttribute("data-turbo-suppress-warning"))
        for (e = e.parentElement; e;) {
            if (e == document.body) return console.warn(u`
...
function Gt(e) {
    return e && "object" == typeof e ? e instanceof Date || e instanceof RegExp ? e : Array.isArray(e) ? e.map(Gt) : Object.keys(e).reduce((function(t, s) {
        return t[s[0].toLowerCase() + s.slice(1).replace(/([A-Z]+)/g, (function(e, t) {
...
class Jt extends HTMLElement {
    ...
    async connectedCallback() {
        Tt(this), this.subscription = await jt(this.channel, {
    ...
    disconnectedCallback() {
        Ct(this), this.subscription && this.subscription.unsubscribe(), this.subscriptionDisconnected()
    }
...
void 0 === customElements.get("turbo-cable-stream-source") && customElements.define("turbo-cable-stream-source", Jt), window.Turbo = Vt, addEventListener("turbo:before-fetch-request", (function(e) {
    if (e.target instanceof HTMLFormElement) {
        ...
        t.addEventListener("turbo:submit-start", (({
            detail: {
                formSubmission: {
                    submitter: e
                }
            ...
            const r = function(e) {
                ...
                }(s.body) ? s.body : new URLSearchParams,
                i = function(e, t, s) {
                    const r = function(e) {
...
var Xt = {
    ...
    Kt = {
        log(...e) {
            this.enabled && (e.push(Date.now()), Xt.logger.log("[ActionCable]", ...e))
        }
    };
...
class Zt {
    ...
    recordConnect() {
        this.reconnectAttempts = 0, delete this.disconnectedAt, Kt.log("ConnectionMonitor recorded connect")
    }
    recordDisconnect() {
    ...
    reconnectIfStale() {
        this.connectionIsStale() && (Kt.log(`ConnectionMonitor detected stale connection. reconnectAttempts = ${this.reconnectAttempts}, time stale = ${Yt(this.refreshedAt)} s, stale threshold = ${this.constructor.staleThreshold} s`), this.reconnectAttempts++, this.disconnectedRecently() ? Kt.log(`ConnectionMonitor skipping reopening recent disconnect. time disconnected = ${Yt(this.disconnectedAt)} s`) : (Kt.log("ConnectionMonitor reopening"), this.connection.reopen()))
    }
    get refreshedAt() {
    ...
    visibilityDidChange() {
        "visible" === document.visibilityState && setTimeout((() => {
            !this.connectionIsStale() && this.connection.isOpen() || (Kt.log(`ConnectionMonitor reopening stale connection on visibilitychange. visibilityState = ${document.visibilityState}`), this.connection.reopen())
        }), 200)
    }
}
...
const {
    message_types: ss,
    protocols: rs
} = ts, is = rs.slice(0, rs.length - 1), ns = [].indexOf;
class os {
    constructor(e) {
        this.open = this.open.bind(this), this.consumer = e, this.subscriptions = this.consumer.subscriptions, this.monitor = new es(this), this.disconnected = !0
    }
    send(e) {
        return !!this.isOpen() && (this.webSocket.send(JSON.stringify(e)), !0)
    }
    open() {
        if (this.isActive()) return Kt.log(`Attempted to open WebSocket, but existing socket is ${this.getState()}`), !1;
        {
            const e = [...rs, ...this.consumer.subprotocols || []];
            return Kt.log(`Opening WebSocket, current state is ${this.getState()}, subprotocols: ${e}`), this.webSocket && this.uninstallEventHandlers(), this.webSocket = new Xt.WebSocket(this.consumer.url, e), this.installEventHandlers(), this.monitor.start(), !0
        }
    }
    close({
        allowReconnect: e
    ...
    reopen() {
        ...
        try {
            ...
            Kt.log(`Reopening WebSocket in ${this.constructor.reopenDelay}ms`), setTimeout(this.open, this.constructor.reopenDelay)
        }
    }
    getProtocol() {
    ...
    isProtocolSupported() {
        return ns.call(is, this.getProtocol()) >= 0
    }
    isState(...e) {
        return ns.call(e, this.getState()) >= 0
    }
    getState() {
        if (this.webSocket)
            for (let e in Xt.WebSocket)
                if (Xt.WebSocket[e] === this.webSocket.readyState) return e.toLowerCase();
        return null
    }
...
os.reopenDelay = 500, os.prototype.events = {
    message(e) {
        ...
        switch (this.monitor.recordMessage(), n) {
            ...
            case ss.disconnect:
                return Kt.log(`Disconnecting. Reason: ${r}`), this.close({
                    allowReconnect: i
                });
            case ss.ping:
                return null;
            case ss.confirmation:
...
var ls = class {
    ...
    guarantee(e) {
        -1 == this.pendingSubscriptions.indexOf(e) ? (Kt.log(`SubscriptionGuarantor guaranteeing ${e.identifier}`), this.pendingSubscriptions.push(e)) : Kt.log(`SubscriptionGuarantor already guaranteeing ${e.identifier}`), this.startGuaranteeing()
    }
    forget(e) {
        Kt.log(`SubscriptionGuarantor forgetting ${e.identifier}`), this.pendingSubscriptions = this.pendingSubscriptions.filter((t => t !== e))
    }
    startGuaranteeing() {
    ...
    retrySubscribing() {
        this.retryTimeout = setTimeout((() => {
            this.subscriptions && "function" == typeof this.subscriptions.subscribe && this.pendingSubscriptions.map((e => {
                Kt.log(`SubscriptionGuarantor resubscribing ${e.identifier}`), this.subscriptions.subscribe(e)
            }))
        }), 500)
    }
};
class hs {
    constructor(e) {
        this.consumer = e, this.guarantor = new ls(this), this.subscriptions = []
    }
    create(e, t) {
        const s = "object" == typeof e ? e : {
                channel: e
            },
            r = new cs(this.consumer, s, t);
        return this.add(r)
    }
    add(e) {
    ...
    notify(e, t, ...s) {
        let r;
        return r = "string" == typeof e ? this.findAll(e) : [e], r.map((e => "function" == typeof e[t] ? e[t](...s) : void 0))
    }
    subscribe(e) {
        this.sendCommand(e, "subscribe") && this.guarantor.guarantee(e)
    }
    confirmSubscription(e) {
        Kt.log(`Subscription confirmed ${e}`), this.findAll(e).map((e => this.guarantor.forget(e)))
    }
    sendCommand(e, t) {
        const {
            identifier: s
...
class ds {
    constructor(e) {
        this._url = e, this.subscriptions = new hs(this), this.connection = new as(this), this.subprotocols = []
    }
    get url() {
        return us(this._url)
    }
...
var ps = Object.freeze({
    __proto__: null,
    Connection: as,
    ConnectionMonitor: es,
    Consumer: ds,
    INTERNAL: ts,
    Subscription: cs,
    Subscriptions: hs,
    SubscriptionGuarantor: ls,
    adapters: Xt,
    createWebSocketURL: us,
    logger: Kt,
    createConsumer: function(e = ms("url") || ts.default_mount_path) {
        return new ds(e)
    },
    getConfig: ms
});
export {
    Vt as Turbo, zt as cable
};
