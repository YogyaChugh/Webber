...
function Ad() {
    const [e, n] = He.useState(!1), [t, r] = He.useState(!1), [l, o] = He.useState(0), i = async () => {
        n(!0);
        try {
            const c = await fetch("https://snakegame-q62g.onrender.com", {
                mode: "no-cors"
            });
            window.open("https://snakegame-q62g.onrender.com", "_blank")
        } catch {
        ...
        children: [C.jsx("nav", {
            ...
            children: C.jsxs("div", {
                ...
                children: [C.jsxs("div", {
                    ...
                    children: [C.jsxs("button", {
                        ...
                        href: "https://github.com/YogyaChugh/SnakeGame.git",
                        target: "_blank",
            ...
            children: [C.jsxs("div", {
                ...
                children: [C.jsx("h2", {
                    ...
                    children: [C.jsxs("a", {
                        href: "../github.com/YogyaChugh/SnakeGame/releases/download/v1.0.0/Snake_Game_Windows.exe",
                        ...
                        href: "../github.com/YogyaChugh/SnakeGame/releases/download/v1.0.0/Snake_Hustler_Linux",
                        download: "Snake Game.exe",
                        className: "bg-[#16213e] hover:bg-[#1f2937] transition-all p-6 rounded-2xl flex flex-col items-center transform hover:scale-105 hover:shadow-neon",
                        children: [C.jsx($d, {
